    ...
    <body>
        ...
        <div id="contenedor" class="ink-grid">
            <div class="column-group">
                ...
                <div>
                	<form action="actualizarPeriodoSeleccionado" class="ink-form">
                        ...
                        <table class="ink-table bordered alternating hover" style="font-size:14px;">
                            ...
                            <tbody>
                                ...
                                */
                                    ...
                                    $infoPeriodo = DB::table('Periodos')->where('idPeriodos',$periodo)->get();
                                    print('<tr>');
                                    print('<td>');
                                    echo Form::text('periodo', $infoPeriodo[0]->periodo);
                                    print('</td>');
                                    print('<td>');
                                    echo Form::text('fechaInicio',$infoPeriodo[0]->fechaInicio,array('type' => 'date', 'placeholder' => 'AA-MM-DD'));
                                    print('</td>');
                                    print('<td>');
                                    echo Form::text('fechaFin',$infoPeriodo[0]->fechaFin,array('type' => 'date', 'placeholder' => 'AA-MM-DD'));
                                    print('</td>');
                                    print('</tr>');
                                ?>
                            </tbody>
                    ...
                    <div class="large-100" style="padding-top:1em;">
                        ...
                        <?php
                            Session::push('idPeriodos',$periodo);
